...
<div id="primary_block" class="clearfix">
	...
	<div id="pb-right-column">
		...
		<div id="image-block">
		{if $have_image}
			<img src="{$link->getImageLink($product->link_rewrite, $cover.id_image, '')}"
				{if $jqZoomEnabled}class="jqzoom" alt="{$link->getImageLink($product->link_rewrite, $cover.id_image, '')}"{else} title="{$product->name|escape:'htmlall':'UTF-8'}" alt="{$product->name|escape:'htmlall':'UTF-8'}" {/if} id="bigpic" />
		{else}
		...
		<ul id="usefull_link_block"">
			...
			<li style="display:none;><a href="javascript:print();">{l s='Print'}</a><br class="clear" /></li>
			{if $have_image && !$jqZoomEnabled}
			<li style="display:none;><span id="view_full_size" class="span_link">{l s='View full size'}</span></li>
			{/if}
		</ul>
	</div>
	...
	<div id="pb-left-column">
		<div id="product_name">
			...
			<div id="product_price">
				...
				<p class="price" style="padding-left: 0; font-weight:normal;">
		...
		<div class="angle">{l s='SEE IT IN DIFFERENT ANGLE' mod=''}</div>
