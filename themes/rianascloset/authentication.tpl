...
{if !isset($email_create)}
	...
	<form action="{$link->getPageLink('authentication.php', true)}" method="post" id="login_form">
		<fieldset>
	...
	<form action="{$link->getPageLink('authentication.php', true)}" method="post" id="create-account_form">
		<fieldset>
...
<link type="text/css" href="{$css_dir}/ui-lightness/jquery-ui-1.8.21.custom.css" rel="stylesheet" />
<link href="{$css_dir}state-select.css" rel="stylesheet" type="text/css" />
